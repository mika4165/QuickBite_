/**
 * Vercel serverless function: /api/__internal/revoke-staff-access
 * Revokes staff access by deleting user, stores, and all related data
 */
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (existing) {
      ...
      await supabase.from("users").delete().eq("id", userInTable.id);
    }
